...
if(ANDROID)
	...
	file(COPY "OgreMain/src/Android/JNI/OgreActivityJNI.java" DESTINATION "${NDKOUT}/src/org/ogre3d/android")
	file(COPY "OgreMain/src/Android/JNI/MainActivity.java" DESTINATION "${NDKOUT}/src/org/ogre3d/android")
    ...
    if(NOT ANDROID_GLES_ONLY)
	  configure_file("${OGRE_TEMPLATES_DIR}/Android-noglue.mk.in" "${NDKOUT}/jni/Android.mk" @ONLY)
    else()

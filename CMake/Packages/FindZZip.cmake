...
if(NOT OGRE_BUILD_PLATFORM_ANDROID)
  ...
  set(ZZip_INCLUDE_DIR "${OGRE_DEPENDENCIES_DIR}/include")
  set(ZZip_LIBRARIES "${OGRE_DEPENDENCIES_DIR}/lib/libzzip-0.a    ${OGRE_DEPENDENCIES_DIR}/lib/libzzipmmapped-0.a
${OGRE_DEPENDENCIES_DIR}/lib/libzzipfseeko-0.a  ${OGRE_DEPENDENCIES_DIR}/lib/libzzipwrap-0.a
${OGRE_DEPENDENCIES_DIR}/lib/libzziplib.a")
  set(ZZip_FOUND TRUE)
endif()
